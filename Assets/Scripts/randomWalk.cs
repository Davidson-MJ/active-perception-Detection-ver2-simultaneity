...
public class randomWalk : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (walk == phase.start)
        {
            ...
            stepDuration = Random.Range(motionParams.stepDurationRange.x, motionParams.stepDurationRange.y);
        ...
        if (walk == phase.walking)
        {
            ...
            if (t > stepDuration)
            {
                ...
                previousLocation.z > upperBoundaries.z || previousLocation.z < lowerBoundaries.z)
                {
                    ...
                    float radius = positionDifference.magnitude - Random.Range(motionParams.stepDistanceRange.x, motionParams.stepDistanceRange.y);
                ...
                else // otherwise keep walking. Set goal position for this step.
                {
                    ...
                    //removing RW in x dimension (depth) for debugging.
                    //These params for sphere shader:
                    ...
                    stepDistance = Random.Range(motionParams.stepDistanceRange.x, motionParams.stepDistanceRange.y);
